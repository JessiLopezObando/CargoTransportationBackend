...
public class DriverUpdateWeightOnAcceptedTicketUseCase implements BiFunction<String, Double, Mono<Driver>> {
    ...
    public Mono<Driver> apply(String id, Double weight) {
        return this.gateway.updateVehicleCapacityOnAcceptedTicket(id, weight);
    }
}
